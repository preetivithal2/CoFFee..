...
const Services = () => {
  ...
  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-7 items-center justify-center p-3 lg:mx-[80px]'>
        <div className='bg-white text-black flex items-center justify-center rounded-4xl m-5 '>
      <div>
