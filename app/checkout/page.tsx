              ...
              {cartItems.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-amber-950">${currency(item.price)} each</p>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="flex items-center border border-gray-300 rounded-md">
                      ...
                      <span className="px-3 text-sm font-medium w-6 text-center text-amber-950">
                        {item.qty}
                      </span>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-6 rounded-lg shadow-md lg:sticky lg:top-8">
            ...
            <div className="space-y-2 border-b pb-4 mb-4">
              ...
              <div className="flex justify-between text-amber-950">
                <span>Shipping</span>
                <span className="font-medium">${currency(SHIPPING_COST)}</span>
              </div>
            </div>
            ...
            <button
              className="w-full mt-6 py-3 bg-amber-950 text-white font-bold rounded-lg hover:opacity-90 transition flex items-center justify-center"
            >
              <CreditCard className="w-5 h-5 mr-2" />
              Proceed to Payment
            </button>
